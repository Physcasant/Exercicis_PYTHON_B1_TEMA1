...
def calculate_angle(angle):
    #Conversió de l’angle que esta en graus a radians
    angle_rad= math.radians(angle)
    #Calcul del sin(angle_rad)
    sin_angle_rad= math.sin(angle_rad)
    # Arrodonim a 2 decimals
    sin_angle_rad_arrodonit_2d=round(sin_angle_rad, 2)
    return sin_angle_rad_arrodonit_2d
